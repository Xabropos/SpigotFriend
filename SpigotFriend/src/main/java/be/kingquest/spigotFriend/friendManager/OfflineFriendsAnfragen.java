...
public class OfflineFriendsAnfragen {

    public static Set<String> offlineFriendsAnfragen(Player p) {
        try (Jedis jedis = new Jedis("89.58.30.136", 6379)) {
            ...
            String query = "SELECT Username FROM " + p.getName() + " WHERE Angenommen = false";
